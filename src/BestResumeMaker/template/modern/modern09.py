...
class ResumePDF:
    def __init__(self, output_file="resume.pdf", page_size="A4", template_image="template.png"):
        ...
        self.content_width = (self.page_width * 2/3) - 57  # 40 = right margin + padding
    ...
    def _add_contact_to_sidebar(self, personal_info):
        ...
        self.sidebar_content.append(Spacer(1, 30))
        ...
        self.sidebar_content.append(Indenter(left=-28))
    ...
    def add_professional_summary(self, summary_text):
        ...
        indent_width = self.page_width * 0.34
