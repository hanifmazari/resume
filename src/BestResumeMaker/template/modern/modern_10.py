...
class ResumePDF:
    def __init__(self, output_file="resume.pdf", page_size="A4", template_image="template.png"):
        ...
        self.content_width = (self.page_width * 2/3) - 63  # 40 = right margin + padding
    ...
    def _setup_styles(self):
        ...
        styles.add(ParagraphStyle(
            ...
            textColor=colors.HexColor("#0654bb")
        ))
    ...
    def add_profile_picture(self, base64_image, size=2.2*inch, border_width=0.001*inch, top_margin=0.5*inch):
    ...
    def _add_contact_to_sidebar(self, personal_info):
        ...
        self.sidebar_content.append(Spacer(1, 70))
        ...
        self.sidebar_content.append(Indenter(left=-27))
        ...
        # Location/Address with icon (optional)
    ...
    def add_professional_summary(self, summary_text):
        ...
        line = HRFlowable(
            ...
            thickness=2,
            lineCap = 'round',
            color=colors.HexColor("#d5dee6"),  # Light gray color
            spaceBefore=4,
            spaceAfter=8,
            hAlign='LEFT'
        )
    ...
    def add_hobbies(self, hobbies):
        ...
        self.sidebar_content.append(line)
        self.sidebar_content.append(Spacer(1, 6))
        # self.sidebar_content.append(Indenter(left=-2710))
    ...
    def draw_later_pages(self, canvas, doc):
        ...
        canvas.saveState()
        try:
            img = ImageReader("modern_l10.png")
            canvas.drawImage(img, 0, 0, width=self.page_width, height=self.page_height)
        except Exception as e:
            try:
