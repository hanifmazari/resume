...
class ResumePDF:
    def __init__(self, output_file="resume.pdf", page_size="A4", template_image="template.png"):
        ...
        self.content_width = (self.page_width * 2/3) - 65  # 40 = right margin + padding
        ...
        self.image_area_height = 2*inch + 0.2*inch + 0.5*inch   # Track current position in sidebar_content
    ...
    def add_profile_picture(self, base64_image, size=2.2*inch, border_width=0.1*inch, top_margin=0.5*inch):
    ...
    def _add_contact_to_sidebar(self, personal_info):
        ...
        line = HRFlowable(
            width=line_width,
            thickness=1,
            color=colors.HexColor("#000000"),  # Light gray color
            spaceBefore=4,
            spaceAfter=8,
            hAlign='LEFT'
        )
    ...
    def add_professional_summary(self, summary_text):
        ...
        line = HRFlowable(
            ...
            thickness=2,
            lineCap = 'round',
            color=colors.HexColor("#0A0606"),  # Light gray color
            spaceBefore=4,
            spaceAfter=8,
            hAlign='LEFT'
        )
